...
def pull_blog(url):
    ...
    # print(len(blogs))
    for blog in blogs:
        postdates = blog.find_element_by_tag_name('time')
    ...
    for i in range(0, len(links)):
        ...
        # time.sleep(2)
        temp = ''
        divs = driver.find_elements_by_class_name('has-content-area')
        for div in divs:
        ...
        #     section = soup.find('div', class_='has-content-area') 
        #     print(soup)
            # temp = ''
...
pull_blog('https://blog.nationalgeographic.org/')

i = 2
while i < 896:
  pull_blog('https://blog.nationalgeographic.org/page' + str(i) + '/')
  time.sleep(2)
  i += 1
